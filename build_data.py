    ...
    return [
      ...
      {"type": "li", "segments": [
        ...
        ph("p-rethink-work", "rethink how things get done",
           ["ev-process-opt", "ev-present-future", "ev-systems-thinking", "pf-eraf", "ev-business-design-thinking"]),
        "."
      ]},
      {"type": "li", "segments": [
      ...
      {"type": "li", "segments": [
        ...
        ph("p-how-work-gets-done", "understand how work gets done and where AI can remove friction or expand capacity",
           ["ev-research", "ev-blueprinting", "ev-process-opt", "pf-legacy-ux", "ev-knowledge-arch-rows"]),
        "."
      ]},
      {"type": "li", "segments": [
      ...
      {"type": "li", "segments": [
        ...
        ph("p-retrieval-prompt", "core concepts such as retrieval and prompt and context design",
           ["ev-km", "ev-ai-reliability", "ev-ai-product", "pf-prompt-engineering", "ev-ai-retrieval"]),
        "."
      ]},
      {"type": "li", "segments": [
